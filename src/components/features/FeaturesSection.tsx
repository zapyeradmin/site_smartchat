    ...
    <section className="container px-4 py-12">
      ...
      <div className="max-w-2xl mb-12">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Inovação para
          <br />
          <span className="text-gradient font-bold">sua Comunicação</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          O Smart Chat representa muito mais do que uma simples ferramenta de comunicação: trata-se de uma verdadeira central de inteligência empresarial.
        </p>
      </div>
